...
columns = ["TF_u","TF_v","TFIDF_u","TFIDF_v","Word_Similarity", "AdamicAdar", "CommonNeighbours", "Jaccard", "PreferentialAttachment", "ResourceAllocation", "Katz", "RootedPageRank", "Simrank"]
